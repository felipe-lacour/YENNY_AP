 ...
 private final Connection connection;
	   ...
	   public AutorControlador() {
	    ...
	    public void addAutor(Autor Autor) {
	        try {
	            PreparedStatement statement = connection.prepareStatement("INSERT INTO autores (name, nacionalidad) VALUES (?, ?)");
	    ...
	    public void updateAutor(Autor Autor) {
	        try {
	            PreparedStatement statement = connection.prepareStatement("UPDATE autores SET name = ?, email = ? WHERE autor_id = ?");
	            statement.setString(1, Autor.getNombre());
	            statement.setString(2, Autor.getNacionalidad());
	    ...
	    public void deleteAutor(int id) {
	        try {
	            PreparedStatement statement = connection.prepareStatement("DELETE FROM autores WHERE autor_id = ?");
	            statement.setInt(1, id);
